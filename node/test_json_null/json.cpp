...
#include "../third_party/cppcms/cppcms/json.h"
#include <iostream>
#include <sstream>
...
int main()
{
    ...
    // null tests
    my_object["null"]["obj"] = cppcms::json::null();
    my_object["null"]["const*const"] = (const cppcms::json::null* const)NULL;
    my_object["null"]["const*"] = (const cppcms::json::null*)NULL;
    my_object["null"]["*const"] = (cppcms::json::null* const)NULL;
    my_object["null"]["*"] = (cppcms::json::null*)NULL;
    my_object["null"]["nullptr"] = nullptr;
    my_object["null"]["NULL"] = NULL;
