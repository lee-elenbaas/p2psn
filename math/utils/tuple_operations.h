...
namespace lee {
  namespace utils {
    ...
    template<typename Function, typename... _Elements>
    constexpr
    auto apply_parallel(const Function& f, const std::tuple<_Elements>& t) -> decltype(std::tuple_cat(std::make_tuple(f(t.head())), apply_parallel(f, t.tail())))
    {
...
/*
    ...
    template <typename Function, typename _Carry, typename _Head, typename... _Tail>
    constexpr
    auto apply_carry(const Function&, const _Carry&, const std::tuple<_Head, _Tail>&);

	namespace {
		template <typename Function, typename _Result, typename _Carry, typename... _Tail>
		constexpr
    ...
    template <typename Function, typename _Carry>
    constexpr
